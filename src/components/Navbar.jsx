        ...
        <div className="flex justify-between items-center h-12">
          <div className="flex items-center">
            <Link to="/" className="flex items-center gap-2">
              <img src="/logo.png" alt="STG Logo" className="h-10 w-auto object-contain" />
              <span className="font-extrabold text-2xl lg:text-3xl text-white tracking-tight drop-shadow-md whitespace-nowrap">STG</span>
            </Link>
          </div>
          ...
          <div className="hidden xl:flex items-center space-x-4 xl:space-x-6 text-[11px] xl:text-xs font-semibold tracking-wider">
            ...
            <a href="#luxec" className="text-gray-200 hover:text-white transition-colors flex items-center gap-1 whitespace-nowrap">STG LUXURY <span className="text-[10px] text-gray-400">▼</span></a>
            <a href="#world" className="text-gray-200 hover:text-white transition-colors flex items-center gap-1 whitespace-nowrap">STG WORLD <span className="text-[10px] text-gray-400">▼</span></a>
      ...
      {isOpen && (
        <div className="xl:hidden bg-[#1a1a1a] absolute w-full mt-4 border-t border-gray-800 shadow-2xl">
          <div className="px-4 pt-2 pb-4 space-y-2">
            ...
            <a href="#luxec" onClick={() => setIsOpen(false)} className="block px-3 py-2 text-white font-medium hover:bg-gray-800 rounded">STG LUXURY</a>
            <a href="#world" onClick={() => setIsOpen(false)} className="block px-3 py-2 text-white font-medium hover:bg-gray-800 rounded">STG WORLD</a>
